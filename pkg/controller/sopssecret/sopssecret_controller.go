...
// Add creates a new SopsSecret Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to SopsSecret
	err = c.Watch(&source.Kind{Type: &mygroupv1beta1.SopsSecret{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by SopsSecret - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &mygroupv1beta1.SopsSecret{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=mygroup.k8s.io,resources=sopssecrets,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileSopsSecret) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the SopsSecret instance
	instance := &mygroupv1beta1.SopsSecret{}
